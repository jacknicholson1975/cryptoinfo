...
function App() {
  ...
  useEffect(()=>{
    Axios.get('https://api.coinstats.app/public/v1/coins?skip=0').then((response)=>setListOfCoins(response.data.coins))
  },[])
  ...
  return (
    ...
    <div className="classDisplay">{filteredCoins.map((coin)=>{
